<div class="form-group {{ $errors->has('numero') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::select('tipo', ['bienes inmuebles', 'maquinaria', 'material de oficina'], null, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::date('fechacompra', null, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::select('estado', ['activo', 'dado de baja'], null, ['class' => 'form-control']) !!}
